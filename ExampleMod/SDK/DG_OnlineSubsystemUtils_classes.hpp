...
// 0x0020 (0x332B0 - 0x33290)
class UIpConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x20];                                      // 0x33290(0x0020) MISSED OFFSET
...
{
public:
	unsigned char                                      LogPortUnreach : 1;                                       // 0x0328(0x0001) (Config)
	unsigned char                                      AllowPlayerPortUnreach : 1;                               // 0x0328(0x0001) (Config)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0329(0x0003) MISSED OFFSET
	uint32_t                                           MaxPortCountToTry;                                        // 0x032C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
...
public:
	...
	float                                              BeaconConnectionInitialTimeout;                           // 0x0350(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              BeaconConnectionTimeout;                                  // 0x0354(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UNetDriver*                                  NetDriver;                                                // 0x0358(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class AOnlineBeaconHostObject*                     BeaconOwner;                                              // 0x0370(0x0008) (ZeroConstructor, IsPlainOldData)
	class UNetConnection*                              BeaconConnection;                                         // 0x0378(0x0008) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBeaconConnectionState>                ConnectionState;                                          // 0x0380(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x5F];                                      // 0x0381(0x005F) MISSED OFFSET
...
public:
	...
	struct FString                                     DestSessionId;                                            // 0x04A0(0x0010) (ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x04B0(0x0028)
	TEnumAsByte<EClientRequestType>                    RequestType;                                              // 0x04D8(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPendingReservationSent;                                  // 0x04D9(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCancelReservation;                                       // 0x04DA(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	int                                                ListenPort;                                               // 0x0370(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0374(0x0004) MISSED OFFSET
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x0378(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData01[0xA0];                                      // 0x0388(0x00A0) MISSED OFFSET
...
{
public:
	struct FString                                     BeaconTypeName;                                           // 0x0348(0x0010) (ZeroConstructor, Transient)
	class UClass*                                      ClientBeaconActorClass;                                   // 0x0358(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x0360(0x0010) (ZeroConstructor)
...
{
public:
	class UPartyBeaconState*                           State;                                                    // 0x0370(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x148];                                     // 0x0378(0x0148) MISSED OFFSET
	bool                                               bNoTimeouts;                                              // 0x04C0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x04C1(0x0003) MISSED OFFSET
	float                                              SessionTimeoutSecs;                                       // 0x04C4(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x04C8(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
...
public:
	...
	bool                                               bIsFromInvite;                                            // 0x0220(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bHandlingDisconnect;                                      // 0x0221(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
