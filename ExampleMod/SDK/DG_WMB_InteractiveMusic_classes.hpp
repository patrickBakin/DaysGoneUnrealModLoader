...
// BlueprintGeneratedClass WMB_InteractiveMusic.WMB_InteractiveMusic_C
// 0x000B (0x00C1 - 0x00B6)
class UWMB_InteractiveMusic_C : public UBase_InteractiveMusic_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass WMB_InteractiveMusic.WMB_InteractiveMusic_C");
		return ptr;
	}
	...
	void SetHighState();
	void SetLow1State();
	void ExecuteUbergraph_WMB_InteractiveMusic(int EntryPoint);
};
