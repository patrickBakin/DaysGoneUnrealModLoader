...
// WidgetBlueprintGeneratedClass UI_HudObjectiveUnlockedNotifications.UI_HudObjectiveUnlockedNotifications_C
// 0x0450 (0x0698 - 0x0248)
class UUI_HudObjectiveUnlockedNotifications_C : public UUserWidget
{
public:
	...
	bool                                               Paused;                                                   // 0x04E0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData05[0x7];                                       // 0x04E1(0x0007) MISSED OFFSET
	struct FUI_HudNotificationDetails                  LastQueDisplayed;                                         // 0x04E8(0x01B0) (Edit, BlueprintVisible, DisableEditOnInstance)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_HudObjectiveUnlockedNotifications.UI_HudObjectiveUnlockedNotifications_C");
		return ptr;
	}


	void ClearNotifications();
	void PauseUnpauseForBanners(bool Pause);
	...
	void NotificationComplete_Event(class UUI_HudObjectiveUnlockedNotifications_C* Widget);
	void QueueFinished();
	void ExecuteUbergraph_UI_HudObjectiveUnlockedNotifications(int EntryPoint);
	void NotificationComplete__DelegateSignature(class UUI_HudObjectiveUnlockedNotifications_C* Widget);
