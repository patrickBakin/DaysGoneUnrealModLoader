...
public:
	...
	bool                                               bPromoteOutputLogWarningsDuringPIE;                       // 0x0071(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bOpenAssetEditorTabsInNewWindow;                          // 0x0072(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7D];                                      // 0x0073(0x007D) MISSED OFFSET
