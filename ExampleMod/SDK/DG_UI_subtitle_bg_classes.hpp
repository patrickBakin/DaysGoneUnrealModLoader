...
// WidgetBlueprintGeneratedClass UI_subtitle_bg.UI_subtitle_bg_C
// 0x0148 (0x0390 - 0x0248)
class UUI_subtitle_bg_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_subtitle_bg.UI_subtitle_bg_C");
		return ptr;
	}
	...
	void Init();
	void SetIconWithSize(class UTexture2D* Texture, float Width, float Height);
	void SetBorderOpacity(float Opacity);
	void SetText(const struct FText& Text);
	void Construct();
	void Tick(struct FGeometry* MyGeometry, float* InDeltaTime);
	void ExecuteUbergraph_UI_subtitle_bg(int EntryPoint);
};
