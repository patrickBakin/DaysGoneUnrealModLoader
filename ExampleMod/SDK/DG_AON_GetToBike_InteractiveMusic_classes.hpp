...
// BlueprintGeneratedClass AON_GetToBike_InteractiveMusic.AON_GetToBike_InteractiveMusic_C
// 0x001B (0x00D1 - 0x00B6)
class UAON_GetToBike_InteractiveMusic_C : public UBase_InteractiveMusic_C
{
public:
	...
	bool                                               AON_ReachedBike;                                          // 0x00D0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AON_GetToBike_InteractiveMusic.AON_GetToBike_InteractiveMusic_C");
		return ptr;
	}
	...
	void SetLow2State();
	void OnPlay();
	void ExecuteUbergraph_AON_GetToBike_InteractiveMusic(int EntryPoint);
};
