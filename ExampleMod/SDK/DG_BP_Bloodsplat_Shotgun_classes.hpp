...
// BlueprintGeneratedClass BP_Bloodsplat_Shotgun.BP_Bloodsplat_Shotgun_C
// 0x0040 (0x0420 - 0x03E0)
class ABP_Bloodsplat_Shotgun_C : public ABP_BloodSplatBase_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Bloodsplat_Shotgun.BP_Bloodsplat_Shotgun_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Bloodsplat_Shotgun(int EntryPoint);
};
