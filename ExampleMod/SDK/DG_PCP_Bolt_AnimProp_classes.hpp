...
// BlueprintGeneratedClass PCP_Bolt_AnimProp.PCP_Bolt_AnimProp_C
// 0x0084 (0x03CC - 0x0348)
class APCP_Bolt_AnimProp_C : public AActor
{
public:
	class UParticleSystemComponent*                    PoisonAmbient;                                            // 0x0348(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass PCP_Bolt_AnimProp.PCP_Bolt_AnimProp_C");
		return ptr;
	}
