...
// BlueprintGeneratedClass WMB_MusicManager.WMB_MusicManager_C
// 0x001B (0x0090 - 0x0075)
class UWMB_MusicManager_C : public UBendMusicManagerBP_C
{
public:
	...
	struct FName                                       WMB_CinSelect;                                            // 0x0088(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass WMB_MusicManager.WMB_MusicManager_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WMB_MusicManager(int EntryPoint);
};
