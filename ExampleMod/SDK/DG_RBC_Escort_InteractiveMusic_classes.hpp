...
// BlueprintGeneratedClass RBC_Escort_InteractiveMusic.RBC_Escort_InteractiveMusic_C
// 0x000B (0x00C1 - 0x00B6)
class URBC_Escort_InteractiveMusic_C : public UBase_InteractiveMusic_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass RBC_Escort_InteractiveMusic.RBC_Escort_InteractiveMusic_C");
		return ptr;
	}
	...
	void SetLow1State();
	void SetHighState();
	void ExecuteUbergraph_RBC_Escort_InteractiveMusic(int EntryPoint);
};
