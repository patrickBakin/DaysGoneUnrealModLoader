...
// WidgetBlueprintGeneratedClass UI_MissionIcon.UI_MissionIcon_C
// 0x0010 (0x0260 - 0x0250)
class UUI_MissionIcon_C : public UBaseUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_MissionIcon.UI_MissionIcon_C");
		return ptr;
	}


	void SetIsMissionOrTask(bool IsMission);
	void Construct();
	void ExecuteUbergraph_UI_MissionIcon(int EntryPoint);
};
