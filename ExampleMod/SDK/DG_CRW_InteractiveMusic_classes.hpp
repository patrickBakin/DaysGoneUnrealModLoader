...
// BlueprintGeneratedClass CRW_InteractiveMusic.CRW_InteractiveMusic_C
// 0x000B (0x00C1 - 0x00B6)
class UCRW_InteractiveMusic_C : public UBase_InteractiveMusic_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass CRW_InteractiveMusic.CRW_InteractiveMusic_C");
		return ptr;
	}
	...
	void SetHighState();
	void SetMediumState();
	void ExecuteUbergraph_CRW_InteractiveMusic(int EntryPoint);
};
