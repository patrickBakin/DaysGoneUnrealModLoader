...
// BlueprintGeneratedClass OW_CombSys_MarauderEnemies_InteractiveMusic.OW_CombSys_MarauderEnemies_InteractiveMusic_C
// 0x001A (0x00D0 - 0x00B6)
class UOW_CombSys_MarauderEnemies_InteractiveMusic_C : public UBase_InteractiveMusic_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass OW_CombSys_MarauderEnemies_InteractiveMusic.OW_CombSys_MarauderEnemies_InteractiveMusic_C");
		return ptr;
	}
	...
	void SetLow2State();
	void OnPlay();
	void ExecuteUbergraph_OW_CombSys_MarauderEnemies_InteractiveMusic(int EntryPoint);
};
