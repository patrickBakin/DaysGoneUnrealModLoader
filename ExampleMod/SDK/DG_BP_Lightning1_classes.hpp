...
// BlueprintGeneratedClass BP_Lightning1.BP_Lightning1_C
// 0x0014 (0x0370 - 0x035C)
class ABP_Lightning1_C : public ABP_LightningBase_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Lightning1.BP_Lightning1_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Lightning1(int EntryPoint);
};
