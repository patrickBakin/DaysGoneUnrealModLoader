...
// WidgetBlueprintGeneratedClass UI_ActiveMissionsListItem.UI_ActiveMissionsListItem_C
// 0x0180 (0x0440 - 0x02C0)
class UUI_ActiveMissionsListItem_C : public UJournalListItem
{
public:
	...
	struct FScriptMulticastDelegate                    OnClicked;                                                // 0x0420(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnHovered;                                                // 0x0430(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_ActiveMissionsListItem.UI_ActiveMissionsListItem_C");
		return ptr;
	}


	void Set_Is_Tracked(bool Is_Tracked);
	void OnSelected();
	void OnDeselected();
	void OnData();
	void BndEvt__MenuInteract_Item_K2Node_ComponentBoundEvent_12987_OnMenuInteractHoverEvent__DelegateSignature();
	void BndEvt__MenuInteract_Item_K2Node_ComponentBoundEvent_12989_OnMenuInteractClickedEvent__DelegateSignature();
	void ExecuteUbergraph_UI_ActiveMissionsListItem(int EntryPoint);
