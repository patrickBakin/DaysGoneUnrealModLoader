...
// BlueprintGeneratedClass BP_RipperSpikesC_Static.BP_RipperSpikesC_Static_C
// 0x005E (0x03C8 - 0x036A)
class ABP_RipperSpikesC_Static_C : public AStaticMeshActor_Env_C
{
public:
	...
	class UStaticMeshComponent*                        v2_fence_01_barbwire__2m_a;                               // 0x03B8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        RIP_Barricade_v2;                                         // 0x03C0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_RipperSpikesC_Static.BP_RipperSpikesC_Static_C");
		return ptr;
	}
