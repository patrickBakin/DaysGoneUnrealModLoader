...
// BlueprintGeneratedClass LOL2_InteractiveMusic.LOL2_InteractiveMusic_C
// 0x000B (0x00C1 - 0x00B6)
class ULOL2_InteractiveMusic_C : public UBase_InteractiveMusic_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass LOL2_InteractiveMusic.LOL2_InteractiveMusic_C");
		return ptr;
	}
	...
	void OnPlay();
	void ExecuteUbergraph_LOL2_InteractiveMusic(int EntryPoint);
};
