...
// BlueprintGeneratedClass ICF_HordeEnemies_InteractiveMusic.ICF_HordeEnemies_InteractiveMusic_C
// 0x007A (0x0130 - 0x00B6)
class UICF_HordeEnemies_InteractiveMusic_C : public UBase_InteractiveMusic_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ICF_HordeEnemies_InteractiveMusic.ICF_HordeEnemies_InteractiveMusic_C");
		return ptr;
	}
	...
	void OnPlay();
	void ExecuteUbergraph_ICF_HordeEnemies_InteractiveMusic(int EntryPoint);
};
