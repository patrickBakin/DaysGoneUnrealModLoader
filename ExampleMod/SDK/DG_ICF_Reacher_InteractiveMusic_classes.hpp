...
// BlueprintGeneratedClass ICF_Reacher_InteractiveMusic.ICF_Reacher_InteractiveMusic_C
// 0x000B (0x00C1 - 0x00B6)
class UICF_Reacher_InteractiveMusic_C : public UBase_InteractiveMusic_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass ICF_Reacher_InteractiveMusic.ICF_Reacher_InteractiveMusic_C");
		return ptr;
	}
	...
	void SetHighState();
	void SetMediumState();
	void ExecuteUbergraph_ICF_Reacher_InteractiveMusic(int EntryPoint);
};
