...
{
public:
	unsigned char                                      UnknownData00[0x130];                                     // 0x00D0(0x0130) MISSED OFFSET
	class UNavMovementComponent*                       MovementComp;                                             // 0x0200(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0208(0x0008) MISSED OFFSET
	class ANavigationData*                             MyNavData;                                                // 0x0210(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData02[0xEC];                                      // 0x0218(0x00EC) MISSED OFFSET
	unsigned char                                      bUseVisibilityTestsSimplification : 1;                    // 0x0304(0x0001) (Config)
	unsigned char                                      UnknownData03[0x9B];                                      // 0x0305(0x009B) MISSED OFFSET
...
public:
	...
	struct FVector                                     CrowdAgentMoveDirection;                                  // 0x03A8(0x000C) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x14];                                      // 0x03B4(0x0014) MISSED OFFSET
	class UCharacterMovementComponent*                 CharacterMovement;                                        // 0x03C8(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	struct FNavAvoidanceMask                           AvoidanceGroup;                                           // 0x03D0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToAvoid;                                            // 0x03D4(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToIgnore;                                           // 0x03D8(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x34];                                      // 0x03DC(0x0034) MISSED OFFSET
...
public:
	...
	unsigned char                                      bStopAILogicOnUnposses : 1;                               // 0x03D8(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bLOSflag : 1;                                             // 0x03D8(0x0001)
	unsigned char                                      bSkipExtraLOSChecks : 1;                                  // 0x03D8(0x0001)
	unsigned char                                      bAllowStrafe : 1;                                         // 0x03D8(0x0001)
	unsigned char                                      bWantsPlayerState : 1;                                    // 0x03D8(0x0001)
	unsigned char                                      UnknownData01[0x7];                                       // 0x03D9(0x0007) MISSED OFFSET
	class UPathFollowingComponent*                     PathFollowingComponent;                                   // 0x03E0(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UBrainComponent*                             BrainComponent;                                           // 0x03E8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAIPerceptionComponent*                      PerceptionComponent;                                      // 0x03F0(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UPawnActionsComponent*                       ActionsComp;                                              // 0x03F8(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlackboardComponent*                        Blackboard;                                               // 0x0400(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UGameplayTasksComponent*                     CachedGameplayTasksComponent;                             // 0x0408(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FScriptMulticastDelegate                    ReceiveMoveCompleted;                                     // 0x0410(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	struct FAIDataProviderFloatValue                   SweetSpotValue;                                           // 0x0178(0x0030) (Edit, DisableEditOnInstance)
	bool                                               bDefineSweetSpot;                                         // 0x01A8(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool STATIC_K2_BeginAction(class APawn* Pawn, class UPawnAction* Action, TEnumAsByte<EAIRequestPriority> Priority);
...
{
public:
	struct FString                                     ControllerName;                                           // 0x0088(0x0010) (Net, ZeroConstructor)
	struct FString                                     pawnName;                                                 // 0x0098(0x0010) (Net, ZeroConstructor)
	struct FString                                     PawnClass;                                                // 0x00A8(0x0010) (Net, ZeroConstructor)
	struct FString                                     DebugIcon;                                                // 0x00B8(0x0010) (Net, ZeroConstructor)
	struct FString                                     MovementBaseInfo;                                         // 0x00C8(0x0010) (Net, ZeroConstructor)
	struct FString                                     MovementModeInfo;                                         // 0x00D8(0x0010) (Net, ZeroConstructor)
	struct FString                                     PathFollowingInfo;                                        // 0x00E8(0x0010) (Net, ZeroConstructor)
	struct FString                                     CurrentAITask;                                            // 0x00F8(0x0010) (Net, ZeroConstructor)
	struct FString                                     CurrentAIState;                                           // 0x0108(0x0010) (Net, ZeroConstructor)
	struct FString                                     CurrentAIAssets;                                          // 0x0118(0x0010) (Net, ZeroConstructor)
	struct FString                                     GameplayTasksState;                                       // 0x0128(0x0010) (Net, ZeroConstructor)
	struct FString                                     NavDataInfo;                                              // 0x0138(0x0010) (Net, ZeroConstructor)
	struct FString                                     MontageInfo;                                              // 0x0148(0x0010) (Net, ZeroConstructor)
	unsigned char                                      bIsUsingPathFollowing : 1;                                // 0x0158(0x0001) (Net)
	unsigned char                                      bIsUsingCharacter : 1;                                    // 0x0158(0x0001) (Net)
	unsigned char                                      bIsUsingBehaviorTree : 1;                                 // 0x0158(0x0001) (Net)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0159(0x0003) MISSED OFFSET
	int                                                NextPathPointIndex;                                       // 0x015C(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	TArray<struct FVector>                             PathPoints;                                               // 0x0160(0x0010) (Net, ZeroConstructor)
	unsigned char                                      UnknownData01[0x38];                                      // 0x0170(0x0038) MISSED OFFSET

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AIModule.AIModuleBasicGameplayDebuggerObject");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData03[0xD8];                                      // 0x0058(0x00D8) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x11];                                      // 0x00A7(0x0011) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x140];                                     // 0x0160(0x0140) MISSED OFFSET
...
{
public:
	struct FString                                     BrainComponentName;                                       // 0x0088(0x0010) (Net, ZeroConstructor)
	struct FString                                     BrainComponentString;                                     // 0x0098(0x0010) (Net, ZeroConstructor)
	unsigned char                                      UnknownData00[0x10];                                      // 0x00A8(0x0010) MISSED OFFSET

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AIModule.BTGameplayDebuggerObject");
		return ptr;
	}
...
public:
	...
	float                                              CoolDownTimeVariance;                                     // 0x006C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               StartLocked;                                              // 0x0070(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               ReturnTrueOnTimeOut;                                      // 0x0070(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0071(0x0007) MISSED OFFSET
...
public:
	...
	unsigned char                                      bDisablePathUpdateOnGoalLocationChange : 1;               // 0x009C(0x0001) (Edit)
	unsigned char                                      bProjectVectorGoalToNavigation : 1;                       // 0x009C(0x0001) (Edit)
	unsigned char                                      bAllowStrafe : 1;                                         // 0x009C(0x0001) (Edit)
	unsigned char                                      bStopOnOverlap : 1;                                       // 0x009C(0x0001) (Edit)
...
public:
	...
	TArray<struct FEnvNamedBlackboardKey>              BBQueryParams;                                            // 0x00C0(0x0010) (Edit, ZeroConstructor)
	...
	bool                                               bUseBBKey;                                                // 0x0100(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData01 : 3;                                        // 0x0070(0x0001)
	unsigned char                                      bResolveCollisions : 1;                                   // 0x0070(0x0001) (Edit, Config)
	unsigned char                                      UnknownData02[0x7F];                                      // 0x0071(0x007F) MISSED OFFSET
...
public:
	...
	class UClass*                                      ItemType;                                                 // 0x0048(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	int                                                OptionIndex;                                              // 0x0050(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0054(0x0004) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnQueryFinishedEvent;                                     // 0x0058(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	TArray<struct FEnvQueryInstanceCache>              InstanceCache;                                            // 0x0090(0x0010) (ZeroConstructor, Transient)
	TArray<class UEnvQueryContext*>                    LocalContexts;                                            // 0x00A0(0x0010) (ZeroConstructor, Transient)
	TArray<class UEnvQueryInstanceBlueprintWrapper*>   GCShieldedWrappers;                                       // 0x00B0(0x0010) (ZeroConstructor)
...
public:
	...
	class UClass*                                      Center;                                                   // 0x0190(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	float                                              QuantizeValue;                                            // 0x00E8(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	bool                                               IgnoreQuerier;                                            // 0x0288(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AIModule.EQSGameplayDebuggerObject");
		return ptr;
	}
...
public:
	...
	class UEnvQuery*                                   QueryTemplate;                                            // 0x0778(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FEnvNamedValue>                      QueryParams;                                              // 0x0780(0x0010) (Edit, ZeroConstructor, EditConst)
	TArray<struct FAIDynamicParam>                     QueryConfig;                                              // 0x0790(0x0010) (Edit, ZeroConstructor)
	float                                              TimeLimitPerStep;                                         // 0x07A0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                StepToDebugDraw;                                          // 0x07A4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EEnvQueryHightlightMode>               HighlightMode;                                            // 0x07A8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x07A9(0x0003) MISSED OFFSET
	unsigned char                                      bDrawLabels : 1;                                          // 0x07AC(0x0001) (Edit)
	unsigned char                                      bDrawFailedItems : 1;                                     // 0x07AC(0x0001) (Edit)
	unsigned char                                      bReRunQueryOnlyOnFinishedMove : 1;                        // 0x07AC(0x0001) (Edit)
	unsigned char                                      bShouldBeVisibleInGame : 1;                               // 0x07AC(0x0001) (Edit)
	unsigned char                                      bTickDuringGame : 1;                                      // 0x07AC(0x0001) (Edit)
	unsigned char                                      UnknownData02[0x3];                                       // 0x07AD(0x0003) MISSED OFFSET
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                             // 0x07B0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2F];                                      // 0x07B1(0x002F) MISSED OFFSET
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AIModule.NavMeshGameplayDebuggerObject");
		return ptr;
	}
...
{
public:
	struct FVector                                     SensingComponentLocation;                                 // 0x0088(0x000C) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0094(0x0004) MISSED OFFSET
	struct FString                                     PerceptionLegend;                                         // 0x0098(0x0010) (Net, ZeroConstructor)
	float                                              DistanceFromPlayer;                                       // 0x00A8(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	float                                              DistanceFromSensor;                                       // 0x00AC(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x00B0(0x0008) MISSED OFFSET

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class AIModule.PerceptionGameplayDebuggerObject");
		return ptr;
	}
