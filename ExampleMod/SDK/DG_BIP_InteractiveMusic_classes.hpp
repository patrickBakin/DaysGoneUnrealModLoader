...
// BlueprintGeneratedClass BIP_InteractiveMusic.BIP_InteractiveMusic_C
// 0x000B (0x00C1 - 0x00B6)
class UBIP_InteractiveMusic_C : public UBase_InteractiveMusic_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BIP_InteractiveMusic.BIP_InteractiveMusic_C");
		return ptr;
	}
	...
	void SetMediumState();
	void OnPlay();
	void ExecuteUbergraph_BIP_InteractiveMusic(int EntryPoint);
};
