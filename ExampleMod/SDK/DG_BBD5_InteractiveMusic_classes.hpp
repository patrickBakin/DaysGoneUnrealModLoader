...
// BlueprintGeneratedClass BBD5_InteractiveMusic.BBD5_InteractiveMusic_C
// 0x001A (0x00D0 - 0x00B6)
class UBBD5_InteractiveMusic_C : public UBase_InteractiveMusic_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BBD5_InteractiveMusic.BBD5_InteractiveMusic_C");
		return ptr;
	}
	...
	void SetLow2State();
	void OnPlay();
	void ExecuteUbergraph_BBD5_InteractiveMusic(int EntryPoint);
};
