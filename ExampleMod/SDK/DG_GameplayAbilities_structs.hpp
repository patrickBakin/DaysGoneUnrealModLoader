...
{
	class UProperty*                                   Attribute;                                                // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FGameplayAbilitySpecDef
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	struct FScalableFloat                              LevelScalableFloat;                                       // 0x0010(0x0020) (Edit, DisableEditOnInstance, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	int                                                InputID;                                                  // 0x0030(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	TEnumAsByte<EGameplayEffectGrantedAbilityRemovePolicy> RemovalPolicy;                                            // 0x0034(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	...
	struct FGameplayAbilitySpecHandle                  AssignedHandle;                                           // 0x0040(0x0004)
...
{
	unsigned char                                      UnknownData00[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	struct FGameplayEffectSpec                         Spec;                                                     // 0x0010(0x0248)
	struct FPredictionKey                              PredictionKey;                                            // 0x0258(0x0018)
	float                                              StartServerWorldTime;                                     // 0x0270(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CachedStartServerWorldTime;                               // 0x0274(0x0004) (ZeroConstructor, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	float                                              StartWorldTime;                                           // 0x0278(0x0004) (ZeroConstructor, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	bool                                               bIsInhibited;                                             // 0x027C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xF3];                                      // 0x027D(0x00F3) MISSED OFFSET
};

// ScriptStruct GameplayAbilities.ActiveGameplayEffectsContainer
// 0x0388 (0x0430 - 0x00A8)
struct FActiveGameplayEffectsContainer : public FFastArraySerializer
{
	unsigned char                                      UnknownData00[0x88];                                      // 0x00A8(0x0088) MISSED OFFSET
	TArray<struct FActiveGameplayEffect>               GameplayEffects_Internal;                                 // 0x0130(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x2F0];                                     // 0x0140(0x02F0) MISSED OFFSET
};
...
struct FActiveGameplayCue : public FFastArraySerializerItem
{
	...
	struct FPredictionKey                              PredictionKey;                                            // 0x0018(0x0018)
	bool                                               bPredictivelyRemoved;                                     // 0x0030(0x0001) (ZeroConstructor, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
...
struct FGameplayCueParameters
{
	...
	struct FName                                       MatchedTagName;                                           // 0x0020(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGameplayTag                                OriginalTag;                                              // 0x0028(0x0008) (BlueprintVisible)
...
struct FAttributeBasedFloat
{
	...
	struct FGameplayTagContainer                       SourceTagFilter;                                          // 0x0088(0x0020) (Edit, DisableEditOnInstance)
	struct FGameplayTagContainer                       TargetTagFilter;                                          // 0x00A8(0x0020) (Edit, DisableEditOnInstance)
};
...
struct FGameplayEffectModifierMagnitude
{
	...
	struct FAttributeBasedFloat                        AttributeBasedMagnitude;                                  // 0x0028(0x00C8) (Edit, DisableEditOnInstance)
	struct FCustomCalculationBasedFloat                CustomMagnitude;                                          // 0x00F0(0x0068) (Edit, DisableEditOnInstance)
	struct FSetByCallerFloat                           SetByCallerMagnitude;                                     // 0x0158(0x0008) (Edit, DisableEditOnInstance)
};
...
struct FGameplayModifierInfo
{
	...
	struct FGameplayEffectModifierMagnitude            ModifierMagnitude;                                        // 0x0030(0x0160) (Edit, DisableEditOnInstance)
	struct FGameplayTagRequirements                    SourceTags;                                               // 0x0190(0x0040) (Edit, DisableEditOnInstance)
	struct FGameplayTagRequirements                    TargetTags;                                               // 0x01D0(0x0040) (Edit, DisableEditOnInstance)
};
...
struct FGameplayEffectExecutionScopedModifierInfo
{
	...
	struct FGameplayEffectModifierMagnitude            ModifierMagnitude;                                        // 0x0018(0x0160) (Edit, DisableEditOnInstance)
	struct FGameplayTagRequirements                    SourceTags;                                               // 0x0178(0x0040) (Edit, DisableEditOnInstance)
	struct FGameplayTagRequirements                    TargetTags;                                               // 0x01B8(0x0040) (Edit, DisableEditOnInstance)
};
...
struct FGameplayEffectExecutionDefinition
{
	...
	TArray<class UClass*>                              ConditionalGameplayEffectClasses;                         // 0x0038(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
};
...
struct FGameplayEffectCue
{
	...
	struct FGameplayTagContainer                       GameplayCueTags;                                          // 0x0010(0x0020) (Edit, DisableEditOnInstance)
};
...
struct FGameplayCuePendingExecute
{
	...
	struct FGameplayEffectSpecForRPC                   FromSpec;                                                 // 0x0030(0x0078)
	struct FGameplayCueParameters                      CueParameters;                                            // 0x00A8(0x00A0)
};
...
struct FPreallocationInfo
{
	...
	class UWorld*                                      OwningWorld;                                              // 0x0060(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
};
...
struct FGameplayTagReponsePair
{
	...
	int                                                SoftCountCap;                                             // 0x0010(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
{
	struct FGameplayTagReponsePair                     Positive;                                                 // 0x0000(0x0018) (Edit)
	struct FGameplayTagReponsePair                     Negative;                                                 // 0x0018(0x0018) (Edit)
};
...
struct FGameplayEffectContext
{
	...
	struct FVector                                     WorldOrigin;                                              // 0x0048(0x000C) (ZeroConstructor, IsPlainOldData)
	bool                                               bHasWorldOrigin;                                          // 0x0054(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	struct FHitResult                                  HitResult;                                                // 0x0008(0x0088)
};
...
struct FGameplayEffectQuery
{
	...
	struct FGameplayAttribute                          ModifyingAttribute;                                       // 0x0128(0x0008) (Edit, BlueprintVisible)
