...
// BlueprintGeneratedClass Bend_BulletImpact_AirTaser.Bend_BulletImpact_AirTaser_C
// 0x0038 (0x0598 - 0x0560)
class ABend_BulletImpact_AirTaser_C : public ABendImpactEffect
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Bend_BulletImpact_AirTaser.Bend_BulletImpact_AirTaser_C");
		return ptr;
	}
