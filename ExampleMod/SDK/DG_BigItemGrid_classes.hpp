...
// WidgetBlueprintGeneratedClass BigItemGrid.BigItemGrid_C
// 0x0040 (0x0288 - 0x0248)
class UBigItemGrid_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BigItemGrid.BigItemGrid_C");
		return ptr;
	}
	...
	void BndEvt__GridWidget_K2Node_ComponentBoundEvent_1194_DLCGridDataChangedDelegate__DelegateSignature();
	void ExecuteUbergraph_BigItemGrid(int EntryPoint);
