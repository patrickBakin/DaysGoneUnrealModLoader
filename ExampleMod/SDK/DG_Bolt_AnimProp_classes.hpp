...
// BlueprintGeneratedClass Bolt_AnimProp.Bolt_AnimProp_C
// 0x007C (0x03C4 - 0x0348)
class ABolt_AnimProp_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Bolt_AnimProp.Bolt_AnimProp_C");
		return ptr;
	}
