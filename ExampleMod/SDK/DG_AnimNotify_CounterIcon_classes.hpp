...
// BlueprintGeneratedClass AnimNotify_CounterIcon.AnimNotify_CounterIcon_C
// 0x0030 (0x0060 - 0x0030)
class UAnimNotify_CounterIcon_C : public UAnimNotifyState
{
public:
	...
	class UParticleSystemComponent*                    NewVar_1;                                                 // 0x0058(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AnimNotify_CounterIcon.AnimNotify_CounterIcon_C");
		return ptr;
	}
