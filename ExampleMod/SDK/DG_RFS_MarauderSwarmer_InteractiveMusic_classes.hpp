...
// BlueprintGeneratedClass RFS_MarauderSwarmer_InteractiveMusic.RFS_MarauderSwarmer_InteractiveMusic_C
// 0x001A (0x00D0 - 0x00B6)
class URFS_MarauderSwarmer_InteractiveMusic_C : public UBase_InteractiveMusic_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass RFS_MarauderSwarmer_InteractiveMusic.RFS_MarauderSwarmer_InteractiveMusic_C");
		return ptr;
	}
	...
	void SetIdleState();
	void SetLow2State();
	void ExecuteUbergraph_RFS_MarauderSwarmer_InteractiveMusic(int EntryPoint);
};
