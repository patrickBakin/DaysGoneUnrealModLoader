...
// BlueprintGeneratedClass LRH_BikeRide_InteractiveMusic.LRH_BikeRide_InteractiveMusic_C
// 0x001B (0x00D1 - 0x00B6)
class ULRH_BikeRide_InteractiveMusic_C : public UBase_InteractiveMusic_C
{
public:
	...
	bool                                               OnBike;                                                   // 0x00D0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass LRH_BikeRide_InteractiveMusic.LRH_BikeRide_InteractiveMusic_C");
		return ptr;
	}
	...
	void OnPlay();
	void SetBikeState();
	void ExecuteUbergraph_LRH_BikeRide_InteractiveMusic(int EntryPoint);
};
