...
struct UUI_Reticle_Crossbow_C_GetReticleTightness_Params
{
...
struct UUI_Reticle_Crossbow_C_DisplaySlowMotionIndicator_Params
{
	bool                                               State;                                                    // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function UI_Reticle_Crossbow.UI_Reticle_Crossbow_C.SetVisible
struct UUI_Reticle_Crossbow_C_SetVisible_Params
{
	bool                                               Visible;                                                  // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function UI_Reticle_Crossbow.UI_Reticle_Crossbow_C.TweenOuterScale
struct UUI_Reticle_Crossbow_C_TweenOuterScale_Params
{
};

// Function UI_Reticle_Crossbow.UI_Reticle_Crossbow_C.Tick
struct UUI_Reticle_Crossbow_C_Tick_Params
{
...
struct UUI_Reticle_Crossbow_C_Construct_Params
{
};

// Function UI_Reticle_Crossbow.UI_Reticle_Crossbow_C.ExecuteUbergraph_UI_Reticle_Crossbow
struct UUI_Reticle_Crossbow_C_ExecuteUbergraph_UI_Reticle_Crossbow_Params
{
	int                                                EntryPoint;                                               // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function UI_Reticle_Crossbow.UI_Reticle_Crossbow_C.FireComplete__DelegateSignature
struct UUI_Reticle_Crossbow_C_FireComplete__DelegateSignature_Params
{
};
