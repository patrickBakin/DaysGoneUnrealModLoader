...
// BlueprintGeneratedClass AON_InteractiveMusic.AON_InteractiveMusic_C
// 0x000B (0x00C1 - 0x00B6)
class UAON_InteractiveMusic_C : public UBase_InteractiveMusic_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AON_InteractiveMusic.AON_InteractiveMusic_C");
		return ptr;
	}
	...
	void SetLow1State();
	void SetHighState();
	void ExecuteUbergraph_AON_InteractiveMusic(int EntryPoint);
};
