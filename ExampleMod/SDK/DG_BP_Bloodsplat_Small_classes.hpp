...
// BlueprintGeneratedClass BP_Bloodsplat_Small.BP_Bloodsplat_Small_C
// 0x0040 (0x0420 - 0x03E0)
class ABP_Bloodsplat_Small_C : public ABP_BloodSplatBase_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Bloodsplat_Small.BP_Bloodsplat_Small_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Bloodsplat_Small(int EntryPoint);
};
