...
// WidgetBlueprintGeneratedClass UI_Challenge_Rep.UI_Challenge_Rep_C
// 0x0070 (0x02B8 - 0x0248)
class UUI_Challenge_Rep_C : public UUserWidget
{
public:
	...
	class UAudioComponent*                             RepAudioComp;                                             // 0x02B0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_Challenge_Rep.UI_Challenge_Rep_C");
		return ptr;
	}
	...
	void SetDetails(int Rep_Gained, int Current_Rep, int Rep_Max, const struct FLinearColor& Color, int* XpCount, int* XPTotal);
	void Construct();
	void Tick(struct FGeometry* MyGeometry, float* InDeltaTime);
	void ExecuteUbergraph_UI_Challenge_Rep(int EntryPoint);
