...
// BlueprintGeneratedClass IYK_InteractiveMusic.IYK_InteractiveMusic_C
// 0x000B (0x00C1 - 0x00B6)
class UIYK_InteractiveMusic_C : public UBase_InteractiveMusic_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass IYK_InteractiveMusic.IYK_InteractiveMusic_C");
		return ptr;
	}
	...
	void SetHighState();
	void SetMediumState();
	void ExecuteUbergraph_IYK_InteractiveMusic(int EntryPoint);
};
